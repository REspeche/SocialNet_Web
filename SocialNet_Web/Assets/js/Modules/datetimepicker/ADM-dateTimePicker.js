        ...
        return {
            ...
            link: function(scope, element, attrs, admDtp) {
                ...
                scope.calTypeChanged = function() {
                    ...
                    scope.monthNames = constants.calendars[scope.calType][scope.option.language].monthsNames;
                    scope.daysNames = constants.calendars[scope.calType][scope.option.language].daysNames;
